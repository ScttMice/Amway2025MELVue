<template>
          ...
          <div class="person_list" >
            <template v-if="personList && personList.length">
              <div class="list" v-for="item in personList" >
                ...
                <van-cell title="签证下载">
                  <template #value>
                    <span style="color:#0486FE" v-if="item.tr3 == 4"  class="flex align-middle justify-end"><img src="../../assets/image/word.png" alt=""> <div style="line-height: 24px;">下载</div></span>
                  </template>
                </van-cell>
              </div>
            </template>
  ...
  <script lang="ts" setup name="person">
      ...
      const upClick = (id:string) => {
        router.push({ name:'upCard',params:{id:id} })
      }
